...
regisBP = Blueprint('auth', __name__)
...
@regisBP.route('/register', methods=['GET', 'POST'])
def register():
    if request.method == 'POST':
        ...
        if existing_user:
            ...
            notification = "User Already registered!"
            return render_template("registration.html", notify = notification)
